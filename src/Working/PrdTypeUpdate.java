 ...
 * @author User
 */
public class PrdTypeUpdate extends javax.swing.JFrame {

    /**
     * Creates new form PrdTypeUpdate
     */
    public PrdTypeUpdate() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Information Change");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrdTypeUpdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrdTypeUpdate().setVisible(true);
            }
        });
    }
