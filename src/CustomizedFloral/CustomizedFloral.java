...
public class CustomizedFloral extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Waxflower", "Lily (oriental)", "Kangaroo Paw", "Gerbera (miniature)", "Eremurus", "Curly Willow" }));

        jComboBox5.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        jComboBox5.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Alstroemeria (Peruvian Lilies)", "Baby's Breath (Gypsophila)", "Carnation", "Hypericum", "Limonium", "Orchid (japhet)" }));

        jLabel10.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jLabel10.setText("Accessories");

        jComboBox6.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        jComboBox6.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Wire Gravestone Saddle", "Heart Wreaths", "Wire Wreath Easel", "Nylon Leaves" }));
